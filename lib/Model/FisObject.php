...
class FisObject implements ModelInterface, ArrayAccess
{
    const DISCRIMINATOR = null;
    
    protected static $RCCPMModelName = 'FisObject';
    
    protected static $RCCPMTypes = [
        'score' => 'int',
        'razones' => 'CirculoDeCredito\ApiResultados\Client\Model\FisRazonObject[]'
    ];
