...
namespace CirculoDeCredito\ApiResultados\Client\Interceptor;
...
use \CirculoDeCredito\ApiResultados\Client\Interceptor\MyLogger;
use \CirculoDeCredito\ApiResultados\Client\Model\Errors;
use \CirculoDeCredito\ApiResultados\Client\Model\Error;

class MiddlewareEvents
{
    
    function __construct(\CirculoDeCredito\ApiResultados\Client\Interceptor\KeyHandler $signer)
    {
        $this->signer = $signer;
...
function build_error($code, $message){
    $error = new \CirculoDeCredito\ApiResultados\Client\Model\Error([
        "code" => $code,
        "message" => $message
    ]);
    $errors = new \CirculoDeCredito\ApiResultados\Client\Model\Errores(["errors" => [$error]]);
